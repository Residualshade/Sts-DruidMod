package druid.cards.common.attack;
...
public class FillerCommonAttack extends CustomCard {
    public static final String ID = "druid:FillerCommonAttack";
